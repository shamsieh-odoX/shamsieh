...
""",
    "version": "19.0.1.2.2",  # adds server-side field guard (credential + workflow-state fields) defense in depth on /botify_agent/rpc; identity endpoint now names which config field(s) are missing
